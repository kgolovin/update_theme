...
git clone --single-branch --branch $INPUT_DESTINATION_BRANCH "https://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@github.com/$INPUT_DESTINATION_REPO.git" "$CLONE_DIR"
